...
With respect to i), I would like to investigate what can be called \emph{dialectical architectures} for lack of a better term.\footnote{Potential alternatives I consider  less descriptive and inclusive: dialogical, argumentative, interactive, adversarial.}  Following \citep[\S 15]{PopperCR1963}, the term `dialectic' has been used in various vague and trivial ways which I want to avoid. I primarily mean it as a shorthand to describe dynamic feedback loops between interactive and functionally specialized components in a complex system. 
