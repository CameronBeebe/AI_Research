...
Community Notes is a feature on X (Formerly Twitter) which uses a model based on history of disagreement between users in order to improve fact checking.  

Jensen Huang suggested a model of AGI where there is a super-model taking into account a committee of sub-models who interact to achieve the super-model's goal (determined via a user).

These are dialectical architectures.
